...
execute @s[tag=!helped,scores={tick=0}] -76 0 -83 fill ~ ~ ~ ~ ~ ~1 command_block 2

titleraw @s[scores={tick=0}] title {"rawtext":[{"translate":"quest.end.title"}]}
titleraw @s[scores={tick=0}] subtitle {"rawtext":[{"translate":"quest.3.end.subtitle"}]}
playsound random.levelup @s[scores={tick=0}] ~ ~ ~ 1 0.75 1

execute @s[scores={tick=0}] ~ ~ ~ tag @e[type=pws:npc_2] remove active
execute @s[scores={tick=0}] ~ ~ ~ tag @e[type=pws:npc_2_firefighter,x=-85,y=68,z=-121,r=1] add active

execute @s[tag=met_bot,scores={tick=0}] ~ ~ ~ tp @e[tag=bot_1] -75 1 -84
execute @s[tag=!met_bot,scores={tick=0}] ~ ~ ~ tp @e[tag=bot_1] -87 68 -121 180 0
execute @s[tag=met_bot,scores={tick=0}] ~ ~ ~ tp @e[tag=bot_2] -87 68 -121 180 0

execute @s[scores={tick=0}] -82 68 -126 fill ~ ~ ~ ~ ~ ~2 air
playsound tile.piston.in @s[scores={tick=0}] ~ ~ ~ 1 1 1
execute @s[scores={tick=10}] -82 69 -126 fill ~ ~ ~ ~ ~ ~2 air
...
execute @s[scores={tick=10}] ~ ~ ~ tp @e[type=agent] -86 68 -122 90 0

scoreboard players set @s[scores={tick=10}] makecode -2
execute @s[scores={tick=10}] ~ ~ ~ scoreboard players set §r objective 900040
